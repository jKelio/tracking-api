...
export class LocationsController {
    ...
    constructor(private locatonService: LocationService, private mapper: LocationResourceMapper) { }

    @UseGuards(JwtAuthGuard)
    @Post()
    public async createOrUpdateLocation(@Req() req: Request, @Body() dto: UpdatedLocationDto): Promise<void> {
    ...
    public async getLocations(@Req() req: Request): Promise<LocationResource[]> {
        return this.mapper.toResources(await this.locatonService.getLocations((req.user as any).userId));
    }
}
